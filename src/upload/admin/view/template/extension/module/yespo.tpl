				...
				<div class="panel-body">
					<div>
						<h4 class="step-title" style="display: flex; align-items: center;">
							...
							<span id="badge-app-inbox" class="badge-status <?php echo ($yespo_app_inbox == '1') ? 'enabled' : 'disabled'; ?>">
								<?php echo ($yespo_app_inbox == '1') ? $text_enabled : $text_disabled; ?>
							</span>
						</h4>
						<p class="text-muted"><?php echo $text_app_inbox_more; ?></p>
					</div>
					<div>
						<button type="button" id="btn-app-inbox" class="btn btn-default" data-status="<?php echo $yespo_app_inbox; ?>">
							<?php echo ($yespo_app_inbox == '1') ? $button_disable : $button_enable; ?>
						</button>
					</div>
				</div>
			</div>
